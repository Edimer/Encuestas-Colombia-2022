...
- [Consultar código 1: `clean_data_wikipedia.R`](https://github.com/Edimer/Encuestas-Colombia-2022/blob/main/clean_data_wikipedia.R)
- [Consultar código 2: `clean_candidate.R`](https://github.com/Edimer/Encuestas-Colombia-2022/blob/main/clean_candidate.R)
